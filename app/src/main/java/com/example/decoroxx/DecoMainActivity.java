                        ...
                        for (int i = 0; i < 5; i++) {
                            ...
                            view.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    intent.putExtra("resId", R.drawable.as);
                                    intent.putExtra("title", "Buchet de trandafiri");
                                    intent.putExtra("description", "\t\t\tBuchet de trandafiri decorat pentru un moment special alaturi de persoana draga. Florile sunt confectionate din sapun, astfel ele nu se vor ofilii niciodata, vor parfuma aerul si vor face persoana draga sa se gandeasca la dumneavoastra.\n" +
                                            "\n\tPretul este cel de jos, livrarea se face in Timisoara si nu se percep costuri in plus.");
                    ...
                    case R.id.events:
                        ...
                        for (int i = 0; i < 5; i++) {
                            ...
                            child2.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    Intent intent = new Intent(DecoMainActivity.this, ProductActivity.class);
                                    intent.putExtra("resId", R.drawable.sa);
                                    intent.putExtra("title", "Buchet de trandafiri");
                                    intent.putExtra("description", "\t\t\tBuchet de trandafiri decorat pentru un moment special alaturi de persoana draga. Florile sunt confectionate din sapun, astfel ele nu se vor ofilii niciodata, vor parfuma aerul si vor face persoana draga sa se gandeasca la dumneavoastra.\n" +
                                            "\n\tPretul este cel de jos, livrarea se face in Timisoara si nu se percep costuri in plus.");
                                    intent.putExtra("price", "50");
